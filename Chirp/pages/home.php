...
function shortenString($str, $max_length = 200) {
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <div class="site-heading">
                        <h1>Blog</h1>
                        <span class="subheading">Share your thoughts with Chirp</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <a href=<?="./post.php?id=". $post['id'] ?>>
                        ...
                        <h3 class="post-subtitle"><?php echo shortenString($post['content']); ?></h3>
                    </a>
                    <p class="post-meta">
                        Posted by
                        <?php echo $post['username']; ?>
                        <?php echo substr($post['created_at'], 0, 16); ?>
                    </p>
                </div>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="small text-center text-muted fst-italic">Copyright &copy; Chirp 2022</div>
                </div>
            </div>
        </div>
    </footer>
